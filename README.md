...
|    | Segment |	Description|
|----|---------|-------------|
| 1.| Premium High |	High passenger volume and high average fares. These routes are strong revenue generators and likely include major business travel corridors.|
